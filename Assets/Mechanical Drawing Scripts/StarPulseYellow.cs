...
public class StarPulseYellow : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // 6 second period instead of 1 for the animation
        // The time value in the Curve is set to 5.5 instead of 6 to make the star disapear for a moment
        if (t > 6)
        {
            // resets timer t
            t = 0;
